;This routine has restricted functionality!!!: it just adds to an existent box the coronal field line computation results
;This routine is not meant to create a box structure out of a gx model!!!!!!
pro gx_model_lines2box,model,box,destroy_model=destroy_bodel
  ...
  if n_elements(oalpha) ne 0 then box=add_tag(box,alpha,'oalpha',/no_copy,/duplicate)
  if n_elements(ocurlb) ne 0 then box=add_tag(box,curlb,'ocurlb',/no_copy,/duplicate)
