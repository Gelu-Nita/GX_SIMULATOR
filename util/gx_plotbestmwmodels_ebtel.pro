;+
; Best of Bests.ps from a CHMP result array. By default does NOT rewrite
; set_a*b*_final.ps (those are written during the search by
; gx_processmodels_ebtel). Pass /replot_final for a full spectrum-mode
; regeneration of every cell final PS, or call gx_replot_chmp_finalps.
;-
