function gx_mwrender_ebtel_script,model,renderer,xc=xc,yc=yc,xfov=xfov, yfov=yfov,nx=nx,ny=ny,gxcube=gxcube
...
;+++++++++++++++++++++++++++++++++
return,gx_mwrender_ebtel(model,renderer,ebtel_path=ebtel_path,q_parms=q_parms,q_formula=q_formula,q0_formula=q0_formula,f_min=17d9,n_freq=1,gxcube=gxcube)
