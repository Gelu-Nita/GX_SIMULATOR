pro GS_Transfer_Slice_64_DP,parms,rowdata,path,parmin,datain,info=info

 if n_elements(path) eq 0 then begin
  dirpath=file_dirname((ROUTINE_INFO('GS_Transfer_Slice_64_DP',/source)).path,/mark)
  path=dirpath+'GS_Transfer_Slice_64_DP.dll'
 end
