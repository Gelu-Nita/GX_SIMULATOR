pro MW_Transfer_Slice_32,parms,rowdata,path,parmin,datain,info=info

 if n_elements(path) eq 0 then begin
  dirpath=file_dirname((ROUTINE_INFO('MW_Transfer_Slice_32',/source)).path,/mark)
  path=dirpath+'MW_Transfer_Slice_32.dll'
 end
