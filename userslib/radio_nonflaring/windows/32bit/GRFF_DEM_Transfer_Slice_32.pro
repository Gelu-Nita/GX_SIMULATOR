pro GRFF_DEM_Transfer_Slice_32,parms,rowdata,nparms,rparms,path,parmin,datain,logtdem=logtdem,$
dem_run=dem_run,ddm_run=ddm_run,qrun=qrun,lrun=lrun,use_dem=use_dem,has_ddm=has_ddm,info=info
 if n_elements(path) eq 0 then begin
  dirpath=file_dirname((ROUTINE_INFO('GRFF_DEM_Transfer_Slice_32',/source)).path,/mark)
