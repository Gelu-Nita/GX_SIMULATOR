pro gx_RenderIrregular_dll, dx, dy, dz, xx, yy, zz, $
                        Nvoxels, VoxList, ds, $
                        x_ind, y_ind, z_ind, $
...
;30Aug-2017 GN: added lib keyword to presrve lib path between subsequent calls
...
if n_elements(lib) eq 0 then begin
 dirpath=file_dirname((routine_info('gx_renderirregular_dll', /source)).path, /mark)
 lib=dirpath+'RenderIrregular'+$
 ...
 if res then print, 'Number of voxels along the line-of-sight exceeds the allowed limit (10000).' $
